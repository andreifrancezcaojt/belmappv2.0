...
<head>
    ...
    <title>Login Form | BELMAppv2.0</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col mx-5 my-1">
                ...
                <h2 class="text-center">Reset Password Successful</h2>
                <?php 
                ...
                ?>
                    ...
                    <div class="form-group">
                        <input class="btn btn-success btn-smaller" type="submit" name="login-now" value="Login Now">
                    </center>
                    </div>
                </form>
            </div>
