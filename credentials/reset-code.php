...
<head>
    ...
    <title>Code Verification | BELMAppv2.0</title>
            ...
            <div class="col-9 mx-5 my-1">
                <form action="reset-code.php" method="POST" autocomplete="off">
                    ...
                    <center>
                        ...
                        <div class="form-group">
                            <input class="btn btn-success btn-smaller" type="submit" name="check-reset-otp" value="Submit">
                        </div>
                    </center>
                </form>
            </div>
