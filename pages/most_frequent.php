    ...
    <div class="container">
        ...
        <div class="table-responsive bg-white shadow">
            <div class="table-wrapper">
                ...
                echo '<a href="javascript:void(0);" ' . ($page1 > 1 ? 'onclick="loadPage(\'pages/most_frequent.php?page1=' . ($page1 - 1) . '&page2=' . $page2 . '\',\'maincontent\')"' : 'style="pointer-events: none; color: gray;"') . '>Prev</a>';
